          ...
          <div className="login-box-2">
            ...
            <div className="row d-flex justify-content-center">
              <div className="col-lg-12 form-login-section">
                <input name="email" type="text" className="form-control col-md-2 login-text-box"  placeholder="name@example.com" id="exampleInputEmail1" aria-describedby="emailHelp" onChange={LoginInfo} value={loginInfo.email}/>
              </div>
              <div className="col-lg-12 form-login-section">
                <input name="password" type="text" className="form-control col-md-2 login-text-box"  placeholder="Password" id="exampleInputEmail1" aria-describedby="emailHelp" onChange={LoginInfo} value={loginInfo.password}/>
              </div>
